class rvm::dependencies::freebsd {
  ...
  if ! defined(Package['which'])           { package { 'which':           ensure => installed, provider => "freebsd", source => "http://ftp.freebsd.org/pub/FreeBSD/ports/amd64/packages-9-stable/Latest/", root => true } }
